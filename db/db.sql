...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`name`,`email`,`time`,`gameid`,`id`),
  KEY `gameid` (`gameid`),
...
INSERT INTO `comments` VALUES ('Kaedehara Kazuha','kazuhakun@yafu.com','Good',5,'2024-06-10 16:58:45','big-farm','1'),('Nguyen Minh','nguyenminh@gmail.com','Game hay',5,'2024-06-12 15:50:32','big-farm','2'),('Phạm Binh An','brianhuster@brianhuster.github.io','Good job, amazing',5,'2024-06-10 11:13:54','big-farm','3'),('Thuy Lam','thuylam@gmail.com','Khong dang nhap duoc',3,'2024-06-12 10:54:09','empire','4');
...
-- Dump completed on 2024-06-12 21:03:23
